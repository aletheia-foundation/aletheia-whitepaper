...
Aletheia can do nothing about the prestige academics get for publishing in paywall journals other than to work to inform people about the negative aspects of paywall journals, but Aletheia can attempt to emulate this prestige to encourage submissions. Aletheia users will generate reputation through various mechanisms outlined in this paper. This reputation, a score than can be drilled into to see exactly what a user has done to contribute to science, from publishing papers, receiving citations to their papers, performing peer reviews and many other things will be stored on the Ethereum blockchain for posterity. While initially encouraging submissions to Aletheia, it's hoped this transparent and quantifiable reputation system could come to be seen as a preferred alternative to the prestige system that constricts academia today.
