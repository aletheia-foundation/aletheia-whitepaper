...
Sci-Hub already exists, Aletheia is not trying to be Sci-Hub. Aletheia is trying to be a missing piece in the open access ecosystem that sists beside Sci-Hub and traditional open access publishers.
...
* Disagreement with acceptance into Aletheia – If something that is not an academic paper or data set makes it past the previous checks a vote can be held to make it unsearchable by the client and removed from seeding, thereby removing it from circulation through Aletheia
