...
In an entire pool review any user can review the document. This option acknowledges that people from all walks of life have valued experience and skills and allows people ouside a set field to review papers. For example, a data scientist with twenty or more years experience in industry might not be able to comment authoritatively on a geology paper, but they might have valued insights related to the data sets and the way the paper interprets their contents. While an unorthodox approach it's hoped this peer review option will demonstrate it's worth and make academia more accessable to everyone.
